...
Route::prefix('back')->name('back.')->middleware('auth')->group(function () {
    Route::get('/dashboard', [DashboardController::class, 'index'])->middleware(['role:admin super|admin hotel'])->name('dashboard');
    Route::get('/dashboard/statistik', [DashboardController::class, 'statistik'])->middleware(['role:admin super|admin hotel'])->name('dashboard.statistik');
    ...
    Route::prefix('metode-pembayaran')->name('metode-pembayaran.')->middleware(['role:admin super|admin hotel'])->group(function () {
    ...
    Route::prefix('transaksi')->name('transaksi.')->middleware(['role:admin super|admin hotel'])->group(function () {
    ...
    Route::prefix('fasilitas-kamar')->name('fasilitas-kamar.')->middleware(['role:admin super|admin hotel'])->group(function () {
    ...
    Route::prefix('tipe-kamar')->name('tipe-kamar.')->middleware(['role:admin super|admin hotel'])->group(function () {
    ...
    Route::prefix('kamar')->name('kamar.')->middleware(['role:admin super|admin hotel'])->group(function () {
    ...
    Route::prefix('ulasan')->name('ulasan.')->middleware(['role:admin super|admin hotel'])->group(function () {
