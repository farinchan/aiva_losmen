...
<div class="
    ...
    <div class="
        ...
        <!--begin:Menu item-->
        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
            class="menu-item menu-lg-down-accordion me-0 me-lg-2"><!--begin:Menu link--><span class="menu-link"><span
        ...
        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
            ...
            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
                ...
                <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href="?page=apps/calendar"><span
        ...
        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
            ...
            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-900px w-xxl-950px">
                @include('back/layout/partials/header/_menu/__layouts')
            </div><!--end:Menu sub-->
        </div><!--end:Menu item--> --}}
        <!--begin:Menu item-->
        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
            class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
            <!--begin:Menu link--><span class="menu-link"><span class="menu-title">Manajemen Aiva Losmen</span><span
                    class="menu-arrow d-lg-none"></span></span><!--end:Menu link--><!--begin:Menu sub-->
            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                ...
                <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                        ...
                        data-bs-dismiss="click" data-bs-placement="right"><span class="menu-icon"><i
                            ...
                            class="menu-title">Hubungi Bantuan</span></a><!--end:Menu link--></div>
                <!--end:Menu item--><!--begin:Menu item--> --}}
                <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                        ...
                        target="_blank"><span class="menu-icon"><i class="ki-duotone ki-code fs-2"><span
                            ...
                            class="menu-title">Butuh Bantuan?</span></a><!--end:Menu link--></div>
                <!--end:Menu item-->
            </div><!--end:Menu sub-->
        </div><!--end:Menu item-->
    </div>
