...
@section('content')
    <div class=" container-xxl " id="kt_content_container">
        <form id="kt_ecommerce_add_category_form"
            ...
            action="{{ route('back.kamar.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card-body pt-0">
                        ...
                        <select class="form-select mb-2" name="tipe_id" data-control="select2" required>
                            @foreach ($tipe_kamar as $tipe)
                                <option @if (old('tipe_id') == $tipe->id) selected @endif value="{{ $tipe->id }}">
                                    {{ $tipe->nama }}</option>
                            @endforeach
                        </select>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="fv-row fv-plugins-icon-container">
                            ...
                            <input type="number" name="nomor_kamar"
                                ...
                                placeholder="Nomor Kamar" value="{{ old('nomor_kamar') }}" required>
                        </div>
                        @error('nomor_kamar')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="card-body pt-0">
                        <div class="fv-row fv-plugins-icon-container">
                            ...
                            <div id="editor" class="min-h-250px mb-2">{{ old('deskripsi') }}
                                <p></p>
                            </div>
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <div class="input-group mb-5">
                                    ...
                                    <input name="harga" type="number"
                                        ...
                                        placeholder="Harga Kamar" aria-label="harga" aria-describedby="basic-addon1" />
                                </div>
                                @error('harga')
                                    <div class="invalid-feedback">
                                        {{ $message }}
