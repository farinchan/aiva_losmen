                            ...
                            <form method="GET" class="card-title">
                                ...
                                <div class="input-group d-flex align-items-center position-relative my-1">
                                    <input type="text" class="form-control form-control-solid  ps-5 rounded-0"
                                        name="q" value="{{ request('q') }}" placeholder="Cari Pelanggan" />
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                            ...
                                            <div class="d-flex mb-4">
                                                ...
                                                <form action="{{ route('back.transaksi.check-in', $transaksi->id) }}"
                                                    method="post">
                                                    @csrf
                                                    <button type="submit"
                                                        class="btn btn-sm btn-primary me-3">Check-In</button>
                                                </form>
