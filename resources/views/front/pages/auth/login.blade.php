        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1 col-md-12 mx-auto thmv-contact-form my-5">
                    ...
                    <form class="row g-3 has-validation" action="{{ route("auth.login.process") }}" method="POST">
                        @csrf
                        <div class="col-md-12">
                            <input required="" type="email" name="email" class="form-control" id="youremail" value="{{ old("email") }}"
                                placeholder="*Email">
                        </div>
                        <div class="col-md-12">
                            <input required="" type="password" name="password" class="form-control" id="yourpassword" value="{{ old("password") }}"
