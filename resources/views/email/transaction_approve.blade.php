				...
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 30px">
                            Kami memberitahukan kepada anda bahwa pemesanan kamar anda telah dibayar dan telah dikonfirmasi oleh pihak kami.
                            silahkan lihat detail pemesanan anda pada halaman pemesanan anda atau dengan menekan tombol dibawah ini:
						</div>
